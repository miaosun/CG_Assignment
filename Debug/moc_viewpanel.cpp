...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_ViewPanel_t, stringdata) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_ViewPanel_t qt_meta_stringdata_ViewPanel = {
    {
QT_MOC_LITERAL(0, 0, 9), // "ViewPanel"
QT_MOC_LITERAL(1, 10, 17), // "setValuesFinished"
QT_MOC_LITERAL(2, 28, 0), // ""
QT_MOC_LITERAL(3, 29, 21), // "showViewPositionPanel"
QT_MOC_LITERAL(4, 51, 9) // "setValues"

    },
    "ViewPanel\0setValuesFinished\0\0"
    "showViewPositionPanel\0setValues"
};
...
void ViewPanel::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        switch (_id) {
        case 0: _t->setValuesFinished(); break;
        case 1: _t->showViewPositionPanel(); break;
        ...
        {
            typedef void (ViewPanel::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&ViewPanel::setValuesFinished)) {
                *result = 0;
            }
        }
    }
...
// SIGNAL 0
void ViewPanel::setValuesFinished()
{
